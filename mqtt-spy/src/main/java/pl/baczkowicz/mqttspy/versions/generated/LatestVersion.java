...
/**
 * <p>Java class for LatestVersion complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LatestVersion">
 *   &lt;complexContent>
...
@XmlType(name = "LatestVersion", propOrder = {
    "keyFeatures"
})
    ...
    implements CopyTo, Copyable, Equals, HashCode, ToString
{
    ...
    public void equals(Object object, EqualsBuilder equalsBuilder) {
        if (!(object instanceof LatestVersion)) {
        ...
        final LatestVersion that = ((LatestVersion) object);
    ...
    public Object copyTo(Object target, CopyBuilder copyBuilder) {
        final LatestVersion copy = ((target == null)?((LatestVersion) createCopy()):((LatestVersion) target));
