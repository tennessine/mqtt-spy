...
// Generated on: 2014.11.11 at 11:45:52 PM GMT 
//
 ...
 *         &lt;element name="BackgroundScript" type="{http://baczkowicz.pl/mqtt-spy/common}Script" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements CopyTo, Copyable, Equals, HashCode, ToString
{
    ...
    protected List<Script> backgroundScript;
     ...
     * 
     */
    public List<Script> getBackgroundScript() {
        if (backgroundScript == null) {
            backgroundScript = new ArrayList<Script>();
        }
    ...
    public void toString(ToStringBuilder toStringBuilder) {
        ...
        {
            List<Script> theBackgroundScript;
    ...
    public Object copyTo(Object target, CopyBuilder copyBuilder) {
        ...
        {
            List<Script> sourceBackgroundScript;
            sourceBackgroundScript = this.getBackgroundScript();
            List<Script> copyBackgroundScript = ((List<Script> ) copyBuilder.copy(sourceBackgroundScript));
            copy.backgroundScript = null;
            List<Script> uniqueBackgroundScriptl = copy.getBackgroundScript();
